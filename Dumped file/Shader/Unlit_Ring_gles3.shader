...
void main()
{
    u_xlat0.xy = (-vs_TEXCOORD0.xy) + _Distort.xy;
    u_xlat0.xy = vec2(u_xlat0.x * _Distort.z, u_xlat0.y * _Distort.w);
    u_xlat0.x = dot(u_xlat0.xy, u_xlat0.xy);
    u_xlat0.x = sqrt(u_xlat0.x);
    u_xlat2 = _InnerRadius + _OuterRadius;
    u_xlat0.x = (-u_xlat2) * 0.5 + u_xlat0.x;
    u_xlat2 = (-u_xlat2) * 0.5 + _OuterRadius;
    ...
    u_xlat16_1.w = 0.0;
    u_xlat16_1.xyz = u_xlat0.xyz * vs_TEXCOORD3.xyz;
...
void main()
{
    ...
    u_xlat0.x = dot(u_xlat0.xy, u_xlat0.xy);
    u_xlat0.x = sqrt(u_xlat0.x);
    u_xlat3 = _InnerRadius + _OuterRadius;
    u_xlat0.x = (-u_xlat3) * 0.5 + u_xlat0.x;
    u_xlat3 = (-u_xlat3) * 0.5 + _OuterRadius;
