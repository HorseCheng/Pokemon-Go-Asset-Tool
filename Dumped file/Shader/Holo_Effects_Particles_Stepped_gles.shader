...
uniform lowp float _ShadowSaturation;
varying lowp vec4 xlv_COLOR;
varying highp vec2 xlv_TEXCOORD0;
void main ()
{
  ...
  col_1.w = xlv_COLOR.w;
  col_1.xyz = mix (xlv_COLOR.xyz, pow (xlv_COLOR, vec4(10.0, 10.0, 10.0, 10.0)).xyz, (_ShadowSaturation * (1.0 - tmpvar_2.xyz)));
  col_1.xyz = (col_1.xyz * tmpvar_2.xyz);
